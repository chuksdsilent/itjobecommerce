            ...
            <div className="search-box-area">
              <div className="select-area flex">
                ...
                >
                  ...
                  <option value="jewelery">Computers</option>
                  <option value="men's clothing">Cars</option>
                  <option value="women's clothing">Furnitures</option>
                  <option value="electronics">Phones & Accesories</option>
                  <option value="jewelery">Others</option>
                </select>
