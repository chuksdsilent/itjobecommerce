...
function Register({ layout }) {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true)
    signup("/register/", values)
    .then(res => {
      setLoading(false)
      console.log(res.data);
      alert.show('Signup Completed...',{type: "success"})
    })
    .catch(err => {
      setLoading(false)
          ...
          <div className="input-container">
            ...
            <div className="row-input ">
              <InputField
                ...
                onChange={handleChange("referralLink")}
              />
            </div>
            <div className="row-input ">
              <InputField
            ...
            <div className="row-input flex">
              <CheckboxInput
                ...
                name="agree"
              />
              <p className="check-label">I agree to Etsea Terms & Condition </p>
            </div>
